...
public class FinanceService {
    ...
    public List<CategoryIDTO> categoryid (String userid){
        List<Object[]> rawData = financeRepo.categoryid(userid);

        List<CategoryIDTO> result = financeRepo.categoryid(userid)
                .stream()
    ...
    public List<CategoryMapDTO> categorymapid (String categoryid,String userid){
        List<Object[]> rawData = financeRepo.mappingid(categoryid,userid);

        List<CategoryMapDTO> result = financeRepo.mappingid(categoryid,userid)
                .stream()
